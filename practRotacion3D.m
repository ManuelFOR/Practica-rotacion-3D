...
for phiRad=0:0.01:angle_rad
 ...
 line([p1(1) p2(1)],[p1(2) p2(2)],[0 0],'color',[0 0 1],'linewidth',2.5); %% traza linea del punto p1 a p2 sobre el eje x
 line([p2(1) p3(1)],[p2(2) p3(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
 line([p3(1) p4(1)],[p3(2) p4(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
 line([p1(1) p4(1)],[p1(2) p4(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
...
p8r = Rt*p8';
 ...
 line([p1r(1) p2r(1)],[p1r(2) p2r(2)],[0 0],'color',[0 0 1],'linewidth',2.5); %% traza linea del punto p1 a p2 sobre el eje x
 line([p2r(1) p3r(1)],[p2r(2) p3r(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
 line([p3r(1) p4r(1)],[p3r(2) p4r(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
 line([p1r(1) p4r(1)],[p1r(2) p4r(2)],[0 0],'color',[0 0 1],'linewidth',2.5);
